...
class FastAgentFramework(BaseFramework):
    ...
    def build_agent_content(self) -> str:
        ...
        config = FastAgentConfig(name="Generated by Agentman", has_prompt_file=self.has_prompt_file)
        ...
        for router in self.config.routers.values():
            router_config = {
                ...
                "model": router.model or self.config.default_model,
                "instruction": router.instruction,
                "default": router.default,
            }
            config.routers.append(router_config)
        ...
        for orchestrator in self.config.orchestrators.values():
            ...
            config.orchestrators.append(orchestrator_config)
