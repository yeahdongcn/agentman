...
class FastAgentConfig:
    ...
    routers: List[Dict[str, Any]] = None
    chains: List[Dict[str, Any]] = None
    orchestrators: List[Dict[str, Any]] = None
...
class FastAgentCodeGenerator:
    ...
    def generate_agent_decorators(self) -> List[str]:
        ...
        for agent_config in self.config.agents:
            lines.append(self._build_agent_decorator(agent_config))
        return lines
    ...
    def generate_router_decorators(self) -> List[str]:
        ...
        for router_config in self.config.routers:
            lines.append(self._build_router_decorator(router_config))
        return lines
    ...
    def generate_chain_decorators(self) -> List[str]:
        ...
        for chain_config in self.config.chains:
            lines.append(self._build_chain_decorator(chain_config))
        return lines
    ...
    def generate_orchestrator_decorators(self) -> List[str]:
        ...
        for orchestrator_config in self.config.orchestrators:
            lines.append(self._build_orchestrator_decorator(orchestrator_config))
        return lines
